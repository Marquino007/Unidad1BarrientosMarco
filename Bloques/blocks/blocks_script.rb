...
full_name.call('Marco', 'Barrientos')
...
full_name.call(first: 'Marco',last: 'Barrientos')
full_name.call(first: 'Juanita',last: 'Gonzalez')
...
def load_users(database, &block)
  ...
  block.call(first: 'Marco', last: 'Barrientos')
end
